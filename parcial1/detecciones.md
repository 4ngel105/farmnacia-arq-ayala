...
| 4 | **D**  | `GestorDePedidos.ProcesarPedido, new BaseDeDatosMySql() y new CorreoSmtp()`,  | El gestor instancia sus propios detalles concretos: depende de clases y no de abstracciones. |